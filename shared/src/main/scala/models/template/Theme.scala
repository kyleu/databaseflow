...
object Theme extends Enum[Theme] with CirceEnum[Theme] {
  ...
  case object DeepPurple extends Theme("deep-purple", "#4527a0")
  case object Indigo extends Theme("indigo", "#3949ab")
  case object Blue extends Theme("blue", "#1976d2")
  case object LightBlue extends Theme("light-blue", "#039be5")
  ...
  case object LightGreen extends Theme("light-green", "#7cb342")
  ...
  case object DeepOrange extends Theme("deep-orange", "#f4511e")
  case object Brown extends Theme("brown", "#6d4c41")
  case object Grey extends Theme("grey", "#757575")
  case object BlueGrey extends Theme("blue-grey", "#607d8b")
