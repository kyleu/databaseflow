...
sealed abstract class ChartType(val id: String, val title: String, options: () => ChartOptions, val canCombine: Boolean = true) extends EnumEntry {
...
object ChartType extends Enum[ChartType] {
  ...
  case object Scatter3D extends ChartType("scatter3d", "3D Scatter Plot", () => ScatterPlot3DOptions(), false)
  case object Bubble3D extends ChartType("bubble3d", "3D Bubble Chart", () => BubbleChart3DOptions(), false)
