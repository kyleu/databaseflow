...
object Server {
  private[this] val dependencies = {
    ...
    Seq(
      Cache.ehCache, Mail.mailer, Akka.actor, Akka.logging, Akka.testkit, Play.playFilters, Play.playWs, Play.playTest,
      Metrics.metrics, Metrics.healthChecks, Metrics.json, Metrics.jvm, Metrics.ehcache, Metrics.jettyServlet, Metrics.servlets, Metrics.graphite,
      WebJars.requireJs, WebJars.jquery, WebJars.materialize
    )
  }
  ...
  lazy val server = Project(
    ...
    .aggregate(Database.dblib)
    .dependsOn(Database.dblib)
}
