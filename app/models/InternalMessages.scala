...
case class SocketStarted(user: Option[User], socketId: UUID, conn: ActorRef) extends InternalMessage
...
case class SocketTraceResponse(id: UUID, userId: Option[UUID], username: Option[String]) extends InternalMessage
