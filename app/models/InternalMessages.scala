...
case class ConnectionStarted(user: Option[User], connectionId: UUID, conn: ActorRef) extends InternalMessage
...
case class ConnectionTraceResponse(id: UUID, userId: Option[UUID], username: Option[String]) extends InternalMessage
